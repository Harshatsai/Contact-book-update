...
public class ContactBookServiceImpl implements ContactBookService {
	...
	@Override
	public int addEnquiry(EnquiryBean enqryId) throws ContactBookException {
		int enqrySeq;
		enqrySeq=contactbookdao.addEnquiry(enqryId);
		return enqrySeq;
	}
	...
	public EnquiryBean getEnquiryDetails(int EnquiryID)throws Exception {
		...
		return null;*/
		EnquiryBean q=new EnquiryBean();
		q=contactbookdao.getEnquiryDetails(EnquiryID);
		return q;
	}
